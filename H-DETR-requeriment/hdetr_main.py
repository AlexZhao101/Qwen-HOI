...
def main(rank, args):
    ...
    def freeze_backbone(self):
        for p in self.interaction_head.backbone.parameters():
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train-detection-dir', default='hicodet/detections/pvic_result/train2015', type=str)
    parser.add_argument('--val-detection-dir', default='hicodet/detections/pvic_result/test2015', type=str)
