...
gdown --proxy=http://127.0.0.1:7890 $ID1
...
gdown --proxy=http://127.0.0.1:7890 $ID2
...
gdown --proxy=http://127.0.0.1:7890 $ID3
...
gdown --proxy=http://127.0.0.1:7890 $ID4
...
gdown --proxy=http://127.0.0.1:7890 $ID5
